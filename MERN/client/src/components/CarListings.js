...
const CarListings = () => {
  ...
  const getApiBaseUrl = () => {
    // Production backend URL - CloudFront provides HTTPS automatically
    const cloudfrontUrl = 'https://d11a1w5wjp8pmi.cloudfront.net/api';
    const envUrl = process.env.REACT_APP_API_URL || (process.env.NODE_ENV === 'production' ? cloudfrontUrl : 'http://localhost:5001/api');
